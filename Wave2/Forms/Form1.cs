...
namespace Wave2.Forms
{
    public partial class Form1 : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            WindowStates.SetInitialLoc = this.Location;
        }
        ...
        private void Min_Button_Click_1(object sender, EventArgs e)
        {
        ...
        private void UpdateFlowPanel()
        {
            ...
            foreach (string item in List.GetListOfNames)
            {
        ...
        private void PlaylistFile_Click(object sender, EventArgs e)
        {
            ...
            string address = List.SearchByName(btn.Text);
            Controlcen.OpenMedia(address, Player_wmp);
            btnB = btn;
        }
        ...
        private void Appliction_KeyUp(object sender, KeyEventArgs e)
        {
            if (Player_wmp.playState == WMPLib.WMPPlayState.wmppsPlaying || Player_wmp.playState == WMPLib.WMPPlayState.wmppsPaused)
            {
                ...
                else if (e.KeyCode == Keys.Space || e.KeyCode == Keys.Enter) Controlcen.TogglePlayPause(Player_wmp);
        ...
        private void Video_panel_DragDrop(object sender, DragEventArgs e)
        {
            ...
            Controlcen.OpenMedia(filenames[0], Player_wmp);

        }
        #endregion
        private Form activeForm = null;
        private void childOpen(Form childForm)
        {
            if (activeForm != null)
                activeForm.Close();
